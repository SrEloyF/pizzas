# Generated by Django 4.2.16 on 2024-11-14 23:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "imagen",
                    models.ImageField(blank=True, null=True, upload_to="repertorio/"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "rol",
                    models.CharField(
                        choices=[("general", "General"), ("otro", "Otro")],
                        max_length=10,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id_proprima",
                    models.ForeignKey(
                        db_column="id_proprima",
                        on_delete=django.db.models.deletion.PROTECT,
                        to="api.productoprima",
                    ),
                ),
                (
                    "id_proventa",
                    models.ForeignKey(
                        db_column="id_proventa",
                        on_delete=django.db.models.deletion.PROTECT,
                        to="api.productoventa",
                    ),
                ),
            ],
            options={
